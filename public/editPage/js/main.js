...
function(t, e) {
    ...
    i.ConfigView = t.ConfigView.extend({
       ...
       ui: {
        ...
        addItem: function() {
            $('<li class="exttypeset clearfix"><div class="delete-item"><img src="public/editPage/images/delete_item.png"/></div><div class="exttypeset-img image-upload" data-name="exttypeset"><img src="public/editPage/images/exttypeset/images/d.png"/></div><div class="exttypeset-link"><div class="input-group"><input class="form-control" type="text" placeholder="链接:http://www.example.com" value="" name="exttypeset_link"><span class="input-group-addon select_url">浏览</span></div></div></li>').appendTo($("#exttypesets-list ul")),
  ...
  var e = $(_.template(n.preview, t)),
    ...
    i.ConfigView = t.ConfigView.extend({
       ...
       ui: {
        ...
        addItem: function() {
            $('<li class="extmenu clearfix"><div class="delete-item"><img src="public/editPage/images/delete_item.png"/></div><div class="extmenu-img image-upload" data-name="extmenu"><img src="public/editPage/images/extmenu/images/d.png"/></div><div class="extmenu-name"><input type="text" name="extmenu_name" placeholder="主标题" class="form-control" value=""/></div><div class="extmenu-link"><div class="input-group"><input class="form-control" type="text" placeholder="链接:http://www.extmenu.com" value="" name="extmenu_link"><span class="input-group-addon select_url">浏览</span></div></div></li>').appendTo($("#extmenus-list ul")),
...
function(t, e) {
    ...
    return i.defaults = {
        ...
        templateId: "tpl_1",
        themeId: "theme-1",
        logo: "public/editPage/images/search/images/default_logo.png"
    },
    i.tpls = {
        tpl_1: n.tpl_1,
        tpl_2: n.tpl_2,
