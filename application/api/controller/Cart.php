...
class Cart extends Base
{
    ...
    public function cart2(){
        ...
        //积分转换
        $dk_point = $this->user['pay_points'] /  tpCache('shopping.point_rate');
        ...
        $this->assign('user',['user_money'=>$this->user['user_money'],'point'=>$this->user['pay_points'],'dk_point'=>$dk_point]);
        DataReturn::returnBase64Json(200,'',$this->viewAssign());
    }
