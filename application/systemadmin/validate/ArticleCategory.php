...
namespace app\systemadmin\validate;
...
class ArticleCategory extends Validate
{
    ...
    {
        $article_system_id = \app\systemadmin\controller\Article::$article_system_id;
        ...
        //错误时跳转到：U('Article/category',array('cat_id'=>$data['cat_id']));
