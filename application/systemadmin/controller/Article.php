...
use think\Page;
use app\systemadmin\logic\ArticleCatLogic;
...
class Article extends Base {
    ...
    public function aticleHandle()
    {
        ...
        //$referurl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : U('Article/articleList');
    ...
    public function linkHandle(){
    	...
    	if($r){
    		$this->success("操作成功",U('Article/linkList'));
    	}else{
            $this->error("操作失败");
    	}
    }
