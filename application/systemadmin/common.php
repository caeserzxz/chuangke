...
{
    $navigate = include APP_PATH.'systemadmin/conf/navigate.php';
    $location = strtolower('systemadmin/'.CONTROLLER_NAME);
    $arr = array(
...
function getMenuArr(){
	$menuArr = include APP_PATH.'systemadmin/conf/menu.php';
