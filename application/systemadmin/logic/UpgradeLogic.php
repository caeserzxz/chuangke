...
class UpgradeLogic extends Model
{
    ...
    function  __construct() {
        ...
        $this->version_txt_path = $this->app_path.'application/systemadmin/conf/version.php'; // 版本文件路径
    ...
    */
    ...
    public  function OneKeyUpgrade(){
        ...
        if(!file_exists($this->app_path.'backup/'.$folderName.'/www/application/systemadmin/conf/version.php'))
